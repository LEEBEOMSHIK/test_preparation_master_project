...
public record UserResponse(Long id, String email, String name, String nickname, String role,
    ...
    public static UserResponse from(User user, List<UserInterestedExam> interests) {
        ...
        return new UserResponse(
                user.getId(), user.getEmail(), user.getName(), user.getNickname(), user.getRole().name(),
