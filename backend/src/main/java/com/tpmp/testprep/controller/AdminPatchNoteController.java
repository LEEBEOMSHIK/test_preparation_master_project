...
public class AdminPatchNoteController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<PatchNoteResponse>>> getAll(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(patchNoteService.adminGetAll(pageable)));
    }
