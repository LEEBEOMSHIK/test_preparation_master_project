...
public class UserPatchNoteController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<PatchNoteResponse>>> getPublished(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(patchNoteService.getPublished(pageable)));
    }
}
